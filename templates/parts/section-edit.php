...
<div class="memdir-section memdir-section--edit" data-section="<?php echo esc_attr( $section_key ); ?>" data-post-id="<?php echo esc_attr( (string) $post_id ); ?>">
	...
	<div class="memdir-section-controls">
		...
		<div class="memdir-section-controls__pmp">
			<button type="button" class="memdir-section-controls__pmp-btn memdir-section-controls__pmp-btn--inherit<?php echo $section_pmp === 'inherit'  ? ' is-active' : ''; ?>" data-pmp="inherit">🔗</button>
			<button type="button" class="memdir-section-controls__pmp-btn memdir-section-controls__pmp-btn--public<?php  echo $section_pmp === 'public'   ? ' is-active' : ''; ?>" data-pmp="public">🌐</button>
			<button type="button" class="memdir-section-controls__pmp-btn memdir-section-controls__pmp-btn--member<?php  echo $section_pmp === 'member'   ? ' is-active' : ''; ?>" data-pmp="member">👥</button>
			<button type="button" class="memdir-section-controls__pmp-btn memdir-section-controls__pmp-btn--private<?php echo $section_pmp === 'private'  ? ' is-active' : ''; ?>" data-pmp="private">🔒</button>
		</div>
