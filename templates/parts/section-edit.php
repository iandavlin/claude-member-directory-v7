...
<div class="memdir-section memdir-section--edit" data-section="<?php echo esc_attr( $section_key ); ?>" data-post-id="<?php echo esc_attr( (string) $post_id ); ?>">
	...
	<div class="memdir-section-controls">
		...
		<div class="memdir-section-controls__pmp">
			<button type="button" class="memdir-section-controls__pmp-btn memdir-section-controls__pmp-btn--public<?php echo $effective_pmp === 'public'  ? ' memdir-section-controls__pmp-btn--active is-active' : ''; ?>" data-pmp="public">🌐</button>
			<button type="button" class="memdir-section-controls__pmp-btn memdir-section-controls__pmp-btn--member<?php echo $effective_pmp === 'member'  ? ' memdir-section-controls__pmp-btn--active is-active' : ''; ?>" data-pmp="member">👥</button>
			<button type="button" class="memdir-section-controls__pmp-btn memdir-section-controls__pmp-btn--private<?php echo $effective_pmp === 'private' ? ' memdir-section-controls__pmp-btn--active is-active' : ''; ?>" data-pmp="private">🔒</button>
		</div>
