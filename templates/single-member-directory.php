...
?>
<div class="memdir-profile<?php echo $is_edit ? ' memdir-profile--edit' : ''; ?><?php echo $is_privileged ? ' memdir-profile--has-panel' : ''; ?>"><?php // --edit modifier drives CSS for edit-only UI; --has-panel enables two-column grid. ?>
